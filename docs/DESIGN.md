...
> Design notes for **build-error-capture** — a runnable go example that Capture backend build diagnostics and group them across release operations from a Go CLI service.
...
- **Feature code** — the actual task: build-error-tracking.
